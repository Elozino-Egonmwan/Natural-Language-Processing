...
public class EcoTest{
	public static void main (String args[]){
		...
		// add 50 bears of age 3
		Animal bear = new Bear (3);
		animals = ecys.addAnimal (bear, 50);
		//add 60 fishes of age 4
		Animal fish = new Fish (4);
		animals = ecys.addAnimal(fish,60);
		//add 90 otters of age 8
		Animal otter = new Otter (8);
		animals = ecys.addAnimal(otter,90);
